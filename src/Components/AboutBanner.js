        ...
        <motion.div style={{ maxWidth: "1200px", margin: "auto" }}>
          <motion.div style={{ maxWidth: "900px", margin: "50px 0 50px auto" }}>
            ...
            >
              ...
              Bootstrap, jQuery, PHP, Python, React, WordPress, MongoDB, Node,
              and Express, I bring a diverse skill set to every project.
            </Pera>
            ...
            >
              ...
              Productions, and Alsalhya, delivering exceptional websites that
            ...
            <Pera
              ...
              transition={{ delay: 1, duration: 0.5 }}
            >
              Graduating in 2022, I am committed to continuous learning and
              expanding my knowledge base. In a rapidly evolving industry, I
              thrive on embracing new technologies and eagerly dive into the
            ...
            <Pera
              ...
              transition={{ delay: 1, duration: 0.5 }}
            >
              I believe in the power of simplicity and user-centered design,
              crafting seamless user experiences that leave a lasting
              impression. With a keen eye for detail and a focus on delivering
              high-quality work, I strive to exceed expectations with each
              project.
            </Pera>
            ...
            <Pera
              ...
              transition={{ delay: 1, duration: 0.5 }}
            >
              As I navigate through the complexities of life, I am motivated by
              the opportunity to collaborate with like-minded individuals and
              organizations. My unwavering dedication to personal and
              professional growth drives me to explore new horizons and stay
        ...
        <motion.div style={{ maxWidth: "1200px", margin: "auto" }}>
          <motion.div style={{ maxWidth: "900px", margin: "50px 0 50px auto" }}>
            ...
            >
              ...
              easier. I usually use Figma or Adobe XD interchangeably for the
              design. For development/coding, I use different tools specific to
              the development of the application or website. Listed below are
              the tools and technologies that I use and I'm knowledgeable with.
            </Pera>
              ...
              <div>
                ...
                >
                  ...
                  <li>
                    <ListAnchor
                      target="_blank"
                      href="https://www.instagram.com/that_s_guy/"
                    >
                  ...
                  <li>
                    <ListAnchor
                      target="_blank"
                      href="https://www.facebook.com/savad.kvr/"
                    >
                      <motion.div style={{ overflow: "hidden" }}>
                        Facebook
                      </motion.div>
              ...
              <div style={{ marginTop: "50px" }}>
                ...
                >
                  <li style={{ width: "fit-content" }}>
                    <ListAnchor href="mailto:savadn632@gmail.com">
                      <motion.div style={{ overflow: "hidden" }}>
                        savadn632@gmail.com
                      </motion.div>
                    </ListAnchor>
